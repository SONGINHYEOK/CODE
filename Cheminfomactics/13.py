...
def multimv(folder_list):
    ...
    start = time.time()
    #try:
    df = pd.read_csv('/Users/song-inhyeok/Documents/ZINC20_cr_project/ZINC20_smi/12/'+folder_list, header=None)
    zid=df[0].tolist()
    #print(zid)
    for i in zid:
...
def main():
    ...
    file_path = '/Users/song-inhyeok/Documents/ZINC20_cr_project/ZINC20_smi/12/'
