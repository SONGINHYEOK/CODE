...
class ScaffoldUploader:
    ...
    def process_scaffold(self):
        ...
        if self.id_list == None:
            ...
            #df = pd.read_csv("/Users/song-inhyeok/CODING/PROTOTYPE/BIChem/NT006/77_final_molecule.csv")
            ...
            if len(smi) <415:
                ...
                if fragment_boolean == False:
                    ...
                    for i, node in enumerate(node_list):
                        ...
                        if frag_list == {} or len(frag_list) == 1:
                            continue
                        else:
...
class Scaffold_Heavy_Uploader:
    ...
    def upload_scaffold_multi(self):
        ...
        df = pd.read_csv('/home/songinhyeok/data/sure_chembl.csv', header=None)
        mol_id_list = df[0].tolist()
        
        
        id_list = []
        for i in range(0, len(mol_id_list)):
            id_list.append(mol_id_list[i*1000 : (i+1)*1000])
